...
function Silver() {
  ...
  const handleGenerateTable = () => {
    ...
    const banglaGram1 =
      getBanglaNumber(inputValueDividedBy100 * 100) + " টাকা।";
    const banglaBoriValue = (inputValueDividedBy100 * 11.66).toFixed(2);
    const banglaBori = getBanglaNumber(banglaBoriValue) + " টাকা।";
    const banglaAna =
      getBanglaNumber((inputValueDividedBy100 * 0.72).toFixed(2)) + " টাকা।";
    const Tola52 =
      getBanglaNumber((inputValueDividedBy100 * 52.5).toFixed(2)) + " টাকা।";
    const Roti =
      getBanglaNumber((inputValueDividedBy100 * 0.12).toFixed(2)) + " টাকা।";
    const banglaGram10 =
      getBanglaNumber((inputValueDividedBy100 * 10).toFixed(2)) + " টাকা।";
    const banglaKg =
      getBanglaNumber((inputValueDividedBy100 * 100).toFixed(2)) + " টাকা।";
  ...
  return (
    <div className="container , roboto">
      <h2>Silver Price Converter</h2>
      <section className="section">
        <input
          type="number"
          placeholder="প্রতি গ্রাম রূপা দাম"
          value={inputValue}
